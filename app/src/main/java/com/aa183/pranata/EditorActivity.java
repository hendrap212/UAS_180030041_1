...
public class EditorActivity extends AppCompatActivity {
    ...
    private EditText mName, mCerita, mGenre, mTanggal;
    ...
    private String name, cerita, genre, picture, tanggal;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCerita = findViewById(R.id.cerita);
        ...
        cerita = intent.getStringExtra("cerita");
    ...
    private void setDataFromIntentExtra() {
        ...
        if (id != 0) {
            ...
            getSupportActionBar().setTitle("Add a Book");
        }
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menu_save:
                ...
                if (id == 0) {
                    ...
                    if (TextUtils.isEmpty(mName.getText().toString()) ||
                            TextUtils.isEmpty(mCerita.getText().toString()) ||
                            TextUtils.isEmpty(mGenre.getText().toString()) ||
            ...
            case R.id.menu_delete:
                ...
                dialog.setMessage("Delete this book?");
    ...
    private void postData(final String key) {
        ...
        String cerita = mCerita.getText().toString().trim();
        ...
        Call<Books> call = apiInterface.insertBook(key, name, cerita, genre, status, tanggal, picture);
    ...
    private void updateData(final String key, final int id) {
        ...
        Call<Books> call = apiInterface.updateBook(key, id,name, cerita, genre, status, tanggal, picture);
    ...
    private void deleteData(final String key, final int id, final String pic) {
        ...
        Call<Books> call = apiInterface.deleteBook(key, id, pic);
    ...
    void readMode(){
        ...
        mCerita.setFocusableInTouchMode(false);
        mGenre.setFocusableInTouchMode(false);
        mName.setFocusable(false);
        mCerita.setFocusable(false);
    ...
    private void editMode(){
        ...
        mCerita.setFocusableInTouchMode(true);
        mGenre.setFocusableInTouchMode(true);
